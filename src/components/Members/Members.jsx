          ...
          ? story.map((story, idx) => (
            <div key={idx} className=" ">
              <div className=" rounded-xl relative  ">
                <div className=" absolute  inset-x-0 bottom-0 bg-opacity-70 names w-[184px] h-[36px] lg:w-[215px] lg:h-[43px] bg-[#A8A8A8] rounded-b-md ">
                  <p className=" flex pt-1 px-3  text-white">{story.firstname}  </p>
                </div>
